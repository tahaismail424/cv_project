    ...
    render() {
        ...
        <div>
            <form>
                ...
                <input onChange={this.handleName} type="text" value={this.state.name} name="dist-name" id="dist-name"/>
                <label htmlFor="dist-date">Date received: </label>
                <input onChange={this.handleDate} type="date" value={this.state.date} name="dist-name" id="dist-date"/>
            </form>
        </div>
