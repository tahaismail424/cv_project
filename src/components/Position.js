    ...
    render() {
        ...
        <div>
            <form>
                ...
                <input onChange={this.handleName} value={this.state.name} type="text" name="pos-name" id="pos-name"/>

                <label htmlFor="description">Description: </label>
                <input onChange={this.handleDescription} value={this.state.description} type="text" name="description" id="description"/>
                    
                <label htmlFor="pos-start">Start date: </label>
                <input onChange={this.handleStart} value={this.state.startDate} type="date" name="pos-start" id="pos-start"/>

                <label htmlFor="pos-end">End date: </label>
                <input onChange={this.handleEnd} value={this.state.endDate} type="date" name="pos-end" id="pos-end"/>
            </form>
        </div>
